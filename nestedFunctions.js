...
const results = outerFunction(2)(3)(4)
document.write(`Функція повертає добуток трьох чисел: ${results}`);
console.log(`Функція повертає добуток трьох чисел: ${results}`) // Повинно повернути 24 (2*3*4)
